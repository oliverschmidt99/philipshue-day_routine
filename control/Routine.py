...
class Routine:
    ...
    def adjust_lighting(self):
        ...
        elif time_span == 2 and self.mod == 2:
            logging.info(f"Daymod\t\tMorning\t\t{self.name_room}")
            self.mod = 3
        ...
        elif time_span == 3 and self.mod == 3:
            logging.info(f"Daymod\t\tAfternoon\t\t{self.name_room}")
            self.mod = 4
        ...
        elif time_span == 4 and self.mod == 4:
            logging.info(f"Daymod\t\tNight\t\t{self.name_room}")
            self.mod = 1
            if self.bri_night == 0:
                self.room.turn_off_groups()
            else:
